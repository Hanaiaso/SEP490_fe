 ...
 * @param {string} id
 * @returns {Promise<{ id, name, sku, standardListedPrice, description, specifications, imageUrl, images: {id: string, imageUrl: string, sortOrder: number}[], categoryId, categoryName, physicalStock, availableStock }>}
 */
